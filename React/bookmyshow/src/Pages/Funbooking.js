...
const Funbooking = () => {
  ...
  const funImage = location.state?.funImage;
  const funName = location.state?.funName;
  const funPrice = location.state?.funPrice;
  ...
  return (
    ...
    <div class="book">
        <div class="left2">
           <img src={funImage} alt="" id="poster" />
        </div>
        <div class="right2">
            <div class="center">
                <div class="tickets">
                  <div class="ticket-selector">
                    ...
                    <div class="timings">
                      ...
                      <div className="tickt" data-amount-per-ticket={funPrice}>
                            <p>
