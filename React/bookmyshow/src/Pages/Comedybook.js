...
const Comedybooking = () => {
  ...
  const comedyImage = location.state?.comedyImage;
  const comedyName = location.state?.comedyName;
  const comedyPrice = location.state?.comedyPrice;
  ...
  const navigatetoDisplay = () => {
    navigate(`display`, {
      state: {
        ...
        comedyImage: comedyImage,
        comedyName: comedyName,
            ...
            <div class="center">
                <div class="tickets">
                  <div class="ticket-selector">
                    <div class="head">
                      <div class="title">{comedyName}</div>
                    </div>
                    <div class="timings">
                      <div class="dates">
                      ...
                      <input type="radio" name="time" id="t1"  />
                        <label for="t1" class="time">18:00</label>
                        <input type="radio" id="t2" name="time" />
                        <label for="t2" class="time"> 21:30 </label>
                      </div>
                      <div className="tickt" data-amount-per-ticket={comedyPrice}>
                            <p>
